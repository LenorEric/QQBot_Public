...
class LicensePlateImageGenerator(object):
    """ 根据车牌类型和车牌号，生成车牌图片 """
    single_blue_plate_bg = mlp('./images/single_blue1.bmp')
    small_new_energy_plate_bg = mlp('./images/small_new_energy.jpg')
    single_yellow1_plate_bg = mlp('./images/single_yellow1.bmp')
    police1_plate_bg = mlp('./images/police1.bmp')
